...
# Código para o saco de palavras
...
# Código para o Chat
def chat():
	print("Luna: Olá, eu sou a Luna, como posso ajudar? (para sair, digite adeus)")
	while True:
		inp = input("Você: ")
		if inp.lower() == "adeus":
			arquivo.close()
		...
		if results[results_index] > 0.7:
			...
			print("Luna: Não entendi, poderia falar novamente em outras palavras?")
